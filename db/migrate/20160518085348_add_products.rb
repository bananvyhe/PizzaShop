class AddProducts < ActiveRecord::Migration
  def change
   ...
   Product.create :title => 'Pepperoni', :description => 'Nice Pepperoni pizza', :price => 400, :size => 30, :is_spicy => true, :is_veg => false, :is_best_offer => true, :path_to_image => '/images/pepperoni.jpg' 
